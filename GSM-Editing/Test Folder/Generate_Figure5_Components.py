...
newGN.setInitialConditions(
    ...
    GSM.createGeneralClassProperties(
        ...
        [  0,   0,   0, 20, 190, 170,   0,   0, 2000,   0,   0]  # Blocker concentrations (lowest to highest genelet index)
    )
)
...
AP.generatePlots(simTimeVals[:t0TOtM]/3600, c4Ic4Curve,
    ...
    colorOffset = 0.5,
    fixedY=(-.3, 10.3),
    plotFileName=targFolder / "Figure_5_B_1"
)
...
AP.generatePlots(inputVals/max(inputVals), C4ProdAndCS4Prod,
    ...
    plotFileName=targFolder / "Figure_5_C_1"
)
...
AP.generatePlots(inputVals/max(inputVals), subtractionC4AndCS4,
    ...
    colorOffset = 1.5,
    fixedY=(-25, 440),
    plotFileName=targFolder / "Figure_5_CD_2"
)
...
AP.generatePlots(inputVals/max(inputVals), bandpassOutput,
    ...
    colorOffset = 1.5,
    plotFileName=targFolder / "Figure_5_D_1"
)
