...
fileName = "20231016_G1S1_C1Prod_Test_G1S1"
...
wellCoords = AA.getWellNames("B7", "G10")
...
AP.generatePlots(timePtsOfInterest, wellsGraphSetup,
    plotXTitles=["G1S1 2X ON", "G1S1 BLK 1X Act", "G1S1 BLK 2X Act"], localXTitle="Time (min)", globalXTitle="Legend: Conc. of Template, Mult. of 8.92*10^(-3) U/uL RNase H",
    ...
    specialOpts = [
        [
            ...
            [
                [
                    ["10 nM, 0x", "20 nM, 0x", "10 nM, 10x", "20 nM, 10x"]
                ]
            ]
        ]
    ],
