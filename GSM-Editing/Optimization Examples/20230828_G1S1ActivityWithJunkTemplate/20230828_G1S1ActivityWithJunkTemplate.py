...
AP.generatePlots(timePtsOfInterest, wellsCursedVersion,
    ...
    colorOffset = 2.5,
    plotFileName="C:/Users/kolis/Desktop/Research/GSM-Editing/Optimization Examples/20230828_G1S1ActivityWithJunkTemplate/20230828GraphOptimized23",
    spacer=2,
    specialOpts = [
...
rateEvalObj.optimizeRates(maxiter=10) #TODO: Check time for 1 simulation. import time, time . time, have a start time, and then initialize, run 100 simulations, then stop time = time.time, then calculate total time.
