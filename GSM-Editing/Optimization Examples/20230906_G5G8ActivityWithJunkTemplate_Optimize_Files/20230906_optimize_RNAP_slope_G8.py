...
#B9,B10
RNAPArr = [4,4,4,4,4,4,1,1,1,1,1,1] # For a J12, J13 traversal starts at 4 for this experiment.
...
AP.generatePlots(timePtsOfInterest, wellsCursedVersion,
    ...
    colorOffset = 2.5,
    plotFileName="C:/Users/kolis/Desktop/Research/LOCALFILES/GSM-Editing/Optimization Examples/20230921_G1G3ActivityWithJunkTemplate_Optimize_Files/Test",
    spacer=2,
    specialOpts = [
        ["Legend", [[["Well 12","Well 13"]]]]
    ],
    fixedY=[-0.05, 1.05]
)
