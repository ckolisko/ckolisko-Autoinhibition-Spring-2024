...
for i in range(numGeneletNetworks):
    ...
    #gNs[-1].modifyRate("AutoInhib-Act-Repressor", 10**-6.809875403382171, 1) # genelet K_M
    gNs[-1].modifyRate("AutoInhib-Free-Act", 10**-3.5714295486860013 , 1) # genelet K_M
    #gNs[-1].modifyRate("AutoInhib-Act-Genelet", 10**-6.588549772193684 , 1) # genelet K_M
