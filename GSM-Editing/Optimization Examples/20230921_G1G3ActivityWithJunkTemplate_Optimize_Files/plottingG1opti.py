...
for i in range(numGeneletNetworks):
    ...
    #gNs[-1].modifyRate("AutoInhib-Act-Repressor", 10**-6.608300858779071 , 1) # genelet K_M
    #gNs[-1].modifyRate("AutoInhib-Free-Act", 10**-2.577676260413136, 1) # genelet K_M
    #gNs[-1].modifyRate("AutoInhib-Act-Genelet", 10**-6.408577118368942 , 1) # genelet K_M
